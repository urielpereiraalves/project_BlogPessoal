...
namespace BLOG_PESSOAL_.src.controladores
{
    [ApiController]
    [Route("api/Postagens")]
    ...
    public class PostagemControlador : ControllerBase
    {
        ...
        private readonly IPostagens _repositorio;
        ...
        public PostagemControlador(IPostagens repositorio)
        {
        ...
        ///        "foto": "URLDAIMAGEM",
        ///        "emailCriador": "gustavo@email.com",
